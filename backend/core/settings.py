...
if any(
    [
        ...
        "LOOPS_LEAD_FIRST_CONTACT_TRANSACTIONAL_ID" not in os.environ,
        "LOOPS_BOOKING_CONFIRMATION_TRANSACTIONAL_ID" not in os.environ,
        "LOOPS_BOOKING_REQUEST_AFTER_APPROVAL_TRANSACTIONAL_ID" not in os.environ,
        "LOOPS_BOOKING_CONFIRMATION_REQUEST_TRANSACTIONAL_ID" not in os.environ,
        "LOOPS_BOOKING_CANCELLATION_NOTIFICATION_TRANSACTIONAL_ID" not in os.environ,
        "LOOPS_TENANT_STATISTICS_TRANSACTIONAL_ID" not in os.environ,
    ]
):
    raise ValueError(
...
- LOOPS_LEAD_FIRST_CONTACT_TRANSACTIONAL_ID
- LOOPS_BOOKING_CONFIRMATION_TRANSACTIONAL_ID
- LOOPS_BOOKING_REQUEST_AFTER_APPROVAL_TRANSACTIONAL_ID
- LOOPS_BOOKING_CONFIRMATION_REQUEST_TRANSACTIONAL_ID
- LOOPS_BOOKING_CANCELLATION_NOTIFICATION_TRANSACTIONAL_ID
- LOOPS_TENANT_STATISTICS_TRANSACTIONAL_ID
"""
    )
...
LOOPS_LEAD_FIRST_CONTACT_TRANSACTIONAL_ID = os.getenv(
    "LOOPS_LEAD_FIRST_CONTACT_TRANSACTIONAL_ID"
)
LOOPS_BOOKING_CONFIRMATION_TRANSACTIONAL_ID = os.getenv(
    "LOOPS_BOOKING_CONFIRMATION_TRANSACTIONAL_ID"
)
LOOPS_BOOKING_REQUEST_AFTER_APPROVAL_TRANSACTIONAL_ID = os.getenv(
    "LOOPS_BOOKING_REQUEST_AFTER_APPROVAL_TRANSACTIONAL_ID"
)
LOOPS_BOOKING_CONFIRMATION_REQUEST_TRANSACTIONAL_ID = os.getenv(
    "LOOPS_BOOKING_CONFIRMATION_REQUEST_TRANSACTIONAL_ID"
)
LOOPS_BOOKING_CANCELLATION_NOTIFICATION_TRANSACTIONAL_ID = os.getenv(
    "LOOPS_BOOKING_CANCELLATION_NOTIFICATION_TRANSACTIONAL_ID"
)

LOOPS_TENANT_STATISTICS_TRANSACTIONAL_ID = os.getenv(
    "LOOPS_TENANT_STATISTICS_TRANSACTIONAL_ID"
)
